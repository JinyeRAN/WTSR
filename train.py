...
def main():
    ...
    parser.add_argument('-opt', type=str, default='./options/train/DTM_x4.json', help='Path to options JSON file.')
    ...
    for epoch in range(start_epoch, NUM_EPOCH + 1):
        ...
        # Train model
        train_loss_list = []
        with tqdm(total=len(train_loader), desc='Epoch: [%d/%d]'%(epoch, NUM_EPOCH), miniters=1,ncols=80) as t:
